"use client"
// Use `import` instead of `use client`
...
import model1 from '../../../public/banner/model1.png';
  ...
  return (
    <Container>
      <div
        ...
        style={{ backgroundImage: `url(${dots})` }} // Fixed template string usage
      >
        <Image
          src={model1} // Removed unnecessary quotes
          alt="model"
          height={872}
          width={500}
